...
namespace VideoLister.API
{
    class UrlBuilder
    {
        ...
        {
            return "https://pt.ptawe.com/api/video-promotion/v1/list?category=" + category + "&clientIp=2001:4c4c:2095:2600:f8a7:130e:d05a:ca2&limit=5&pageIndex=" + pageIndex + "&tags=" + tags + "forcedPerformers"+ actress + "&psid=balint&accessKey=4dcdc998265be0ffcc1e7e978fd2ccf1&primaryColor=FFEEEE&labelColor=EEFFEE";
        }
